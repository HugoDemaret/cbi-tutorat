...
def main():
    try:
        with open(INPUT_HASH, mode = "r", encoding='utf-8-sig') as hash, open(INPUT_INFO, mode = "r",encoding='utf-8-sig') as info, open(OUTPUT, mode = "w",encoding='utf-8-sig') as output:
